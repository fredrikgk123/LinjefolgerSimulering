#!/usr/bin/env python3
"""
preview_track.py — plot track with spawn, checkpoints and lap-zone circles.
...
from config import (MAP_SIZE_M, SPAWN_REGISTRY, START_FINISH_RADIUS,
                    MIN_DEPARTURE_DIST, MAX_LATERAL_ERROR, MAX_LAP_TIME,
                    CHECKPOINT_REGISTRY, CHECKPOINT_RADIUS)
